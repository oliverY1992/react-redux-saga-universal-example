  ...
  createClass(ValuesSchema, [{
    ...
    value: function denormalize(input, unvisit, entities) {
      ...
      return Object.keys(input).reduce(function (output, key) {
        ...
        return _extends({}, output, defineProperty({}, key, _this3.denormalizeValue(entityOrId, unvisit, entities)));
      }, {});
    }
  }]);
  return ValuesSchema;
...
var denormalize$2 = function denormalize$2(schema, input, unvisit, entities) {
  schema = validateSchema(schema);
...
var ArraySchema = function (_PolymorphicSchema) {
  ...
  createClass(ArraySchema, [{
    ...
    key: 'denormalize',
    value: function denormalize$2(input, unvisit, entities) {
      var _this3 = this;
...
var unvisit = function unvisit(input, schema, entities) {
  if ((typeof schema === 'undefined' ? 'undefined' : _typeof(schema)) === 'object' && (!schema.normalize || typeof schema.normalize !== 'function')) {
    var method = _denormalize;
    if (Array.isArray(schema)) {
      method = denormalize$2;
    }
